...
namespace App\Http\Controllers\Backend\Import\Payment;
...
class PaymentController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        // dd($last_query);
        return view('backend.import.payment.index', compact('sl_no_filter'));
    }
    ...
    {
        //
        return view('backend.import.payment.import-file');
    }
    ...
    {
        //
        // Excel::import(new PaymentsImport, $request->import_payment);
        // Excel::import(new PaymentsImport, $request->import_payment, 'local', \Maatwebsite\Excel\Excel::XLSX);
        
        try {
            \Excel::import(new PaymentsImport, $request->import_payment);
            activity("Payment Import")
            ->performedOn(new Payment())
