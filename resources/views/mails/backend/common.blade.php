                ...
                <table style="background-color: #f2f3f8; max-width:670px; margin:0 auto;" width="100%" border="0"
                    ...
                    <tr>
                        <td style="text-align:center;">
                            <a href="https://felicitasanalytical.com" title="logo" target="_blank">
                                <img width="60"
                                    src="https://felicitasanalytical.com/uploads/settings/1597251129-output-onlinepngtools.png"
                                    title="logo" alt="logo">
                            </a>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="text-align:center;">
                            <p
                                ...
                                &copy; <strong>felicitasanalytical.com</strong> </p>
                        </td>
                    </tr>
                    <tr>
                        <td style="height:80px;">&nbsp;</td>
