            ...
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h2 class="fw-bold text-primary mb-1">
                        <i class="bi bi-receipt me-2"></i>Payment Note Details
                    </h2>
        ...
        <div class="col-12">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">{{ $note->formatted_order_no ?? 'N/A' }}</li>
                </ol>
            </nav>
        </div>
    </div>
        ...
        <div class="col-lg-8">
            ...
            <div class="card border-0 shadow-sm mb-4">
                ...
                <div class="card-body p-4">
                    <div class="row">
                        <div class="col-12">
                            @include('backend.paymentNote.partials.payment-approval-template', [
                                'note' => $note,
                            ])
                        </div>
                    </div>
            ...
            @if($note->greenNote)
                <div class="card border-0 shadow-sm mb-4">
                    <div class="card-header bg-white border-0 py-3">
                        <h5 class="card-title mb-0">
                            <i class="bi bi-link text-primary me-2"></i>Related Documents
                        </h5>
                    </div>
                    <div class="card-body p-4">
                        <div class="d-flex gap-2 mb-3">
                            <a href="{{ route('backend.note.view.pdf', $note->greenNote->id) }}" class="btn btn-outline-primary">
                                <i class="bi bi-eye me-1"></i>View Green Note
                            </a>
                        </div>
            ...
            @elseif($note->reimbursementNote)
                <div class="card border-0 shadow-sm mb-4">
                    ...
                    <div class="card-body p-4">
                        <div class="d-flex gap-2 mb-3">
                            <a href="{{ route('backend.reimbursement-note.view.pdf', $note->reimbursementNote->id) }}" class="btn btn-outline-primary">
                                <i class="bi bi-eye me-1"></i>View Reimbursement Note
                            </a>
                        </div>
                                    ...
                                    <tbody>
                                        @foreach (json_decode($note->reimbursementNote->file_path, true) as $key => $file)
                                            <tr>
                                                ...
                                                <td>{{ $note->reimbursementNote->created_at->setTimezone('Asia/Kolkata')->format('d/m/Y h:i A') }}</td>
                                                <td>
            ...
            <div class="card border-0 shadow-sm mb-4">
                ...
                <div class="card-body p-4">
                    <div class="position-relative">
                        ...
                        <!-- Steps -->
                        @foreach ($note->paymentApprovalLogs as $index => $step)
                    ...
                    <div class="card-body p-4">
                        <div class="d-grid gap-2">
                            ...
                            <div id="remarksSection" style="display: none;">
                                <form id="rejectForm" action="{{ route('backend.payment-note-approval.approvalLogUpdate', $note->id) }}" method="POST">
                                    @csrf
