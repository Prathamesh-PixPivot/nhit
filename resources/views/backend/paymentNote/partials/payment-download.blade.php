...
<body>
    <header>
        <table width="100%" cellspacing="0" cellpadding="5">
            ...
            <tr>
                <td colspan="12" style="text-align:center; font-weight: 700; font-size:16px;">Note for Approval of
                    Payment
                </td>
            </tr>
            <tr>
    ...
    <table style="border: 0px solid #000; table-layout: fixed; width: 100%;" cellspacing="0">
        {{-- <tr>
            <td colspan="12" style="text-align:center; font-weight: 700; font-size:20px;">NHIT WESTERN PROJECTS
                PRIVATE
                LIMITED</td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td colspan="4" style="font-size:14px;"><strong>Department:</strong>
                @if ($note->greenNote)
                    {{ $note->greenNote->department->name ?? '-' }}
                @elseif ($note->reimbursementNote)
                    {{ $note->reimbursementNote->user->department->name ?? '' }}
                @else
                    N/A
                @endif
            </td>
        ...
        <tr>
            @if ($approvers->count() > 3)
                <td colspan="4" style="font-size:14px;">Approver 4</td>
                @php
