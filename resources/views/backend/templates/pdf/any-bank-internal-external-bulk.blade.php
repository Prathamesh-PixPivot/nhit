...
// echo convertNumberToWordsForIndia("985685989"); exit;
...
@if (!empty($data) && $data->isNotEmpty())
    ...
    <body>
        <table style="border: 0px solid #000;" cellspacing="0">
            <tr>
                <td style="border: 0px solid #000; font-size: 10px; float: none; text-align: center;" colspan="9">
            ...
            <tr>
                <td style="border: 0px solid #000;font-size: 10px;" colspan="6">
                    <strong> {{ config('app.note_icon') }}{{ \Carbon\Carbon::now()->format('y') }}
                        {{ $data[0]?->sl_no ?? '' }}</strong>
                </td>
                <td style="border: 0px solid #000; text-align: left; float: left;font-size: 10px;" colspan="3">
                    <strong>Date: </strong>
                </td>
            </tr>
            <tr>
                <td style="border: 0px solid #000;font-size: 10px;" colspan="9">
                    <br><br>
            ...
            <tr>
                ...
                <td style="border: 1px solid #000;font-size: 10px;" colspan="1">Bank Name</td>
                <td style="border: 1px solid #000;font-size: 10px;" colspan="1">IFSC</td>
            ...
            @foreach ($data as $row)
                ...
                <tr>
                    ...
                    <td style="border: 1px solid #000;font-size: 13px;" colspan="1">
                    ...
                    <td style="border: 1px solid #000;font-size: 10px;" colspan="1">
                        <strong>{{ $row->name_of_bank ?? '' }}</strong>
                    </td>
                    <td style="border: 1px solid #000;font-size: 15px;" colspan="1">
            ...
            @endforeach
            <tr>
                <td style="border: 0px solid #000; font-size: 5px;" colspan="9">
                    <br><br>
