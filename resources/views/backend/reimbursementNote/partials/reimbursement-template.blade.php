...
<body>
    <table cellpadding="5" cellspacing="0" style="border: 1px solid #000; table-layout: fixed; width: 100%;">
        <tr>
        ...
        <tr>
            ...
            <td colspan="1" style="border:1px solid;"><strong>Bill number</strong></td>
            ...
            <td colspan="2" style="border:1px solid;"><strong>Supporting Available</strong></td>
        ...
        @foreach ($note->expenses as $expense)
            <tr>
                ...
                <td colspan="1" style="border:1px solid;">{{ $expense->bill_number }}</td>
                ...
                <td colspan="2" style="border:1px solid;">{{ $expense->supporting_available ? 'Yes' : 'No' }}</td>
