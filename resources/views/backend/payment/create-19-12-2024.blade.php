                ...
                <form class="" action="{{ route('backend.payments.store') }}" method="post"
                    ...
                    <div class="col-md-12 mt-5 btnRequestForm {{ empty(\Cache::get('cart')) ? 'hide' : 'show' }}">
                        ...
                        <div class="form-check mt-3">
                            ...
                            <input type="text" name="shortcut_name" placeholder="Enter shortcut name" id="shortcut_name" class="form-control" style="display:none;">
                                ...
                                results: $.map(data.data, function(item) {
                                    ...
                                    if (item.vendor_type == 'External') {
                                        ...
                                        //     .length - 4) + '-' + item.short_name
                                         ...
                                         project_name = item.benificiary_name;
