...
@section('title', 'Approval Rules - ' . ($approvalFlow->vendor->project ?? 'N/A'))
            ...
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h2 class="fw-bold text-success mb-1">
                        <i class="bi bi-diagram-3 me-2"></i>Approval Rules Management
                    </h2>
                    <p class="text-muted mb-0">Configure and manage approval workflows</p>
                </div>
                <div class="d-flex gap-2">
                    <a href="{{ route('backend.note.rule') }}" class="btn btn-outline-secondary">
        ...
        <div class="col-12">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item">
                        <a href="{{ route('backend.note.rule') }}">Approval Rules</a>
                    </li>
                    <li class="breadcrumb-item active" aria-current="page">{{ $approvalFlow->vendor->project ?? 'N/A' }}</li>
                </ol>
            </nav>
        </div>
    </div>
            ...
            <div class="card border-0 shadow-sm mb-4">
                <div class="card-header bg-white border-0 py-3">
                    <h5 class="card-title mb-0">
                        <i class="bi bi-info-circle text-success me-2"></i>Approval Flow Details
                    </h5>
                </div>
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="step-info flex-grow-1">
                                        <div class="d-flex justify-content-between align-items-center mb-2">
                                            ...
                                            <span class="badge bg-warning text-dark">₹{{ \App\Helpers\Helper::formatIndianNumber($step->amount) }}</span>
                                        </div>
...
@push('script')
    <script>
        $(document).ready(function() {
            // Add any specific JavaScript for approval rules if needed
        });
    </script>
@endpush
