...
<body>
    <table cellpadding="0" cellspacing="1" style="width: fixed; *width: inherit;">
        ...
        <tr>
            <td colspan="12" style="text-align: center; font-size:18px; font-weight: 700; border: none;">Note for
                Approval of {{ $note->approval_for ?? '-' }} payment</td>
        </tr>
        <tr>
        ...
        <tr>
            <td colspan="3" style="border:none;font-size:14px;"><strong>Date:</strong>
                {{ $note->created_at->setTimezone('Asia/Kolkata')->format('d/m/Y h:i A') ?? '-' }}</td>
            <td colspan="3" style="border:none;font-size:14px;"><strong>Project:</strong>
                {{ $note->vendor->project ?? '-' }}</td>
            <td colspan="3" style="border:none;font-size:14px;"><strong>Department:</strong>
                {{ $note->department->name ?? '-' }}</td>
            <td colspan="3" style="border:none;font-size:14px;"><strong>Note No.:</strong>
                {{ $note->formatted_order_no ?? '-' }} </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td colspan="3" style="border:none;font-size:14px;"><strong>Taxable Value:</strong><br>
                Rs.
        ...
        <tr>
            ...
            <td colspan="8" style="border:none;font-size:14px; ">
                <div class="d-flex justify-content-between w-75">
                    <div style="text-align: left;"><strong>Taxable Value:</strong></div>
                    <div style="text-align: right;">
                        {{ \App\Helpers\Helper::formatIndianNumber($note->invoice_base_value) ?? '-' }}</div>
                </div>
                <div class="d-flex justify-content-between w-75">
        ...
        <!--<tr>
            <td colspan="4">Signature Maker</td>
            <td colspan="4">Signature Approver 1</td>
            <td colspan="4">Signature QS </td>
        </tr>-->
        <tr>
        ...
        @endif
        <!--<tr>
            <td colspan="3">Signature Approver 2</td>
            <td colspan="3">Signature Approver 3</td>
            <td colspan="3">Signature Approver 4</td>
            <td colspan="3">Signature Approver 5</td>
        </tr>-->
        <tr>
