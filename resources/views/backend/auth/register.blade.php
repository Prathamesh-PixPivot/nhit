                ...
                <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
                    ...
                    <div class="d-flex justify-content-center py-4">
                        <a href="index.html" class="logo d-flex align-items-center w-auto">
                            ...
                            <span class="d-none d-lg-block">{{ __('NHI') }}</span>
                        </a>
                    </div><!-- End Logo -->
                    ...
                    <div class="card mb-3">
                        ...
                        <div class="row mb-0">
                            ...
                            <form method="POST" action="{{ route('backend.register') }}" class="row g-3 needs-validation"
                                novalidate>
                                @csrf
                                <div class="col-12">
                                ...
                                <div class="col-12">
                                    ...
                                    <p class="small mb-0">Already have an account? <a href="{{route('backend.login')}}">Log in</a></p>
                                    @endif
                                </div>
                            </form>
                        </div>
