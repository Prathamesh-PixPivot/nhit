            ...
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form class="row g-3" action="{{ route('backend.payments.store') }}" method="post">
                            @csrf

                            <div class="col-md-6">
                                <label for="full_account_number" class="form-label">Full Account Number</label>
                                <div class="col-md-12">
                                    <input type="text" class="form-control @error('full_account_number') is-invalid @enderror"
                                        id="full_account_number" name="full_account_number" value="{{ old('full_account_number') ?? '' }}">
                                    @error('full_account_number')
