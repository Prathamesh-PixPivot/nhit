@echo off
REM Fixed Laravel Optimization Script for Windows XAMPP
REM This script addresses PHP extension issues and optimizes Laravel application

echo Starting Fixed Laravel optimization for Windows XAMPP...
...
echo.
echo ========================================
echo Fixed Laravel Optimization Started
echo ========================================

echo.
echo Step 1: Creating optimized PHP configuration without missing extensions...
REM Create a clean PHP configuration without problematic extensions
(
echo.
echo ; Optimized PHP Configuration for Laravel - Windows XAMPP
...
echo.
echo ; Essential extensions that are usually available
echo extension=gd
echo extension=curl
echo extension=zip
...
) > "%PHP_PATH%\php_optimized.ini"

echo Optimized PHP configuration created!

echo.
echo Step 2: Fixing PSR-4 autoloading issues...
REM Remove problematic files that don't comply with PSR-4
if exist "app\channels\DatabaseChannel.php" (
    echo Removing non-compliant DatabaseChannel.php...
    del "app\channels\DatabaseChannel.php"
)

if exist "app\Http\Controllers\Backend\Dashboard\DashboardController copy 2.php" (
    echo Removing duplicate DashboardController copy 2.php...
...
if exist "app\Http\Controllers\Backend\Dashboard\DashboardController copy.php" (
    echo Removing duplicate DashboardController copy.php...
...
if exist "app\Http\Controllers\Backend\Payment\PaymentController copy.php" (
    echo Removing duplicate PaymentController copy.php...
    del "app\Http\Controllers\Backend\Payment\PaymentController copy.php"
)

echo PSR-4 issues fixed!

echo.
echo Step 3: Creating optimized .env file for Windows...
REM Create optimized .env file without Redis dependencies
(
...
echo.
echo ; Redis disabled for Windows XAMPP
...
echo.
echo Step 4: Clearing Laravel caches with file-based cache...
REM Clear caches using file-based cache instead of Redis
...
echo.
echo Step 6: Building Laravel caches with file-based cache...
...
echo.
echo Step 9: Creating performance monitoring script...
...
echo.
echo Step 10: Creating development setup script...
...
echo.
echo Step 11: Creating production deployment script...
...
echo.
echo Step 13: Creating maintenance script...
...
echo.
echo Step 14: Creating extension installation guide...
REM Create extension installation guide
(
echo @echo off
echo echo PHP Extension Installation Guide for Windows XAMPP...
echo.
...
echo Extension installation guide created!

echo.
echo ========================================
echo Fixed Laravel Optimization Completed!
echo ========================================
echo.
echo Issues Fixed:
echo - Removed problematic PHP extensions
echo - Fixed PSR-4 autoloading issues
echo - Created file-based cache configuration
echo - Removed Redis dependencies
echo - Fixed duplicate controller files
echo.
echo Created files:
...
echo - install_extensions.bat (Extension installation guide)
echo - .env (Optimized environment file)
echo - php_optimized.ini (Optimized PHP configuration)
echo.
echo Next steps:
echo 1. Run monitor_performance.bat to check performance
echo 2. Run setup_development.bat for development
echo 3. Run install_extensions.bat to install missing extensions
